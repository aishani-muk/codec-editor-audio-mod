...
# (Use a %-style template to avoid collision with the literal ``{id}`` placeholder.)
AUDIO_NOTE = """
...
After downloading, place audio files in: %(output_dir)s/audio/
...
def download_deam(output_dir: str):
    ...
    if not audio_dir.exists():
        ...
        print(AUDIO_NOTE % {"output_dir": output_dir})
